...
public class EventBridgeSinkConfig extends AbstractConfig {
  ...
  public EventBridgeSinkConfig(final Map<?, ?> originalProps) {
    ...
    log.info(
        "EventBridge properties: connectorId={} eventBusArn={} eventBusRegion={} eventBusEndpoint={} "
            + "eventBusRoleArn={} eventBusRoleSessionName={} eventBusRoleExternalID={} "
            + "eventBusMaxRetries={} eventBusRetriesDelay={} "
            + "eventBusResources={}",
        connectorId,
        eventBusArn,
        region,
