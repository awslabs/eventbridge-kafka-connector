...
public class ProducerTopicCreator {
    private final Logger log = LoggerFactory.getLogger(ProducerTopicCreator.class);

    private final Admin admin;

    public ProducerTopicCreator(Properties properties) {
